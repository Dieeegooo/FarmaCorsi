...
import FornitoreCarrello from './src/contesti/ContestoCarrello';
...
// 3. FornitoreCarrello: il carrello globale (dentro l'utente, perché lo usa)
// 4. Navigatore: sceglie Login oppure tab in base all'utente
function App() {
  return (
    <SafeAreaProvider>
